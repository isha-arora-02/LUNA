...
class TrainValLUNA:
    def __init__(self, num_classes=7, img_dim=1024, omics_dim=663, embed_dim=512, lr=1e-4):
        """
        Parameters:
...
if __name__ == "__main__":
    ...
    gene_expr_dat = pd.read_csv("gene_expr_data/mergedExpr.csv", index_col=0)
    ...
    with open('/home/provido/provido/luna2/image_data/scin_meta/images_sorted2.pkl', 'rb') as f:
